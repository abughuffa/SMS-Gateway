...
public final class ActivityConnectionBinding implements ViewBinding {
  ...
  private ActivityConnectionBinding(@NonNull LinearLayout rootView, @NonNull Button btnCancel,
      @NonNull Button btnSave, @NonNull TabLayout tabLayout, @NonNull ViewPager2 viewPager) {
  ...
  public static ActivityConnectionBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityConnectionBinding((LinearLayout) rootView, btnCancel, btnSave, tabLayout,
          viewPager);
    }
