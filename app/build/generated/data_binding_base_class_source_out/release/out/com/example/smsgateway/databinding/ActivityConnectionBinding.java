...
public final class ActivityConnectionBinding implements ViewBinding {
  ...
  @NonNull
  public final MaterialAutoCompleteTextView actConnectionType;
  ...
  public static ActivityConnectionBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.actConnectionType;
      MaterialAutoCompleteTextView actConnectionType = ViewBindings.findChildViewById(rootView, id);
      if (actConnectionType == null) {
        break missingId;
      }
